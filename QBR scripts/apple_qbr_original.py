...
def create_health_metrics_tables(cursor, start_date='2025-07-01', end_date='2025-10-01'):
    ...
    execute_with_timing(cursor, f"""
        ...
        WITH ranked_weights AS (
            ...
            JOIN tmp_apple_users au ON bwv.user_id = au.user_id
    ...
    # Create baseline and latest BMI tables - FILTERED BY DATE RANGE AND BMI VALUE CHECK
    ...
    execute_with_timing(cursor, f"""
        ...
        WITH ranked_a1c AS (
            ...
            FROM a1c_values av
            JOIN tmp_apple_users au ON av.user_id = au.user_id
    ...
    execute_with_timing(cursor, f"""
        ...
        WITH ranked_bp AS (
            ...
            JOIN tmp_apple_users au ON bpv.user_id = au.user_id
    ...
    # Create GLP1 users table - FIXED COLUMN REFERENCE ERROR
    ...
    execute_with_timing(cursor, f"""
        ...
        user_prescription_coverage AS (
            SELECT 
                ...
                SUM(total_prescription_days) as total_covered_days,  -- Changed: SUM the source column
                ...
                CASE 
                    ...
                    THEN ((DATEDIFF(MAX(prescription_end_date), MIN(prescribed_at)) - SUM(total_prescription_days)) * 100.0 / 
                          DATEDIFF(MAX(prescription_end_date), MIN(prescribed_at)))  -- Changed: SUM the source column
                    ELSE 0 
    ...
    # Create indexes - UPDATE THIS LINE to include the GLP1 table
...
def create_a1c_analysis_table(cursor, start_date='2025-07-01', end_date='2025-10-01'):
    ...
    execute_with_timing(cursor, f"""
        ...
        FROM a1c_values a1
        JOIN tmp_apple_users au ON a1.user_id = au.user_id
...
def create_module_completion_table(cursor, start_date='2025-07-01', end_date='2025-10-01'):
    """Create module completion analysis table for Apple users"""
    ...
    execute_with_timing(cursor, f"""
        ...
        SELECT 
            ...
            -- Total Apple users for reference
            COUNT(DISTINCT au.user_id) as total_apple_users,
...
def get_health_outcomes_query():
    ...
    return """
        SELECT 
            'Apple Users Health Outcomes' as metric_category,
            
            -- Overall Weight Loss Metrics
            COUNT(DISTINCT apple_users.user_id) as total_apple_users,
            ...
            -- Weight metrics for GLP1 users only
        ...
        FROM tmp_apple_users apple_users
        LEFT JOIN tmp_baseline_weight bw ON apple_users.user_id = bw.user_id
        LEFT JOIN tmp_latest_weight lw ON apple_users.user_id = lw.user_id
        LEFT JOIN tmp_baseline_bmi bb ON apple_users.user_id = bb.user_id
        LEFT JOIN tmp_latest_bmi lb ON apple_users.user_id = lb.user_id
        LEFT JOIN tmp_baseline_a1c ba ON apple_users.user_id = ba.user_id
        LEFT JOIN tmp_latest_a1c la ON apple_users.user_id = la.user_id
        LEFT JOIN tmp_baseline_blood_pressure bbp ON apple_users.user_id = bbp.user_id
        LEFT JOIN tmp_latest_blood_pressure lbp ON apple_users.user_id = lbp.user_id
        LEFT JOIN tmp_apple_glp1_users glp1 ON apple_users.user_id = glp1.user_id
        ...
        SELECT 
            ...
            COUNT(DISTINCT apple_users2.user_id) as total_apple_users,
        ...
        FROM tmp_apple_users apple_users2
        LEFT JOIN tmp_baseline_blood_pressure bbp2 ON apple_users2.user_id = bbp2.user_id
        LEFT JOIN tmp_latest_blood_pressure lbp2 ON apple_users2.user_id = lbp2.user_id
        ...
        SELECT 
            ...
            COUNT(DISTINCT apple_users3.user_id) as total_apple_users,
        ...
        FROM tmp_apple_users apple_users3
        LEFT JOIN tmp_baseline_blood_pressure bbp3 ON apple_users3.user_id = bbp3.user_id
        LEFT JOIN tmp_latest_blood_pressure lbp3 ON apple_users3.user_id = lbp3.user_id
    """
...
def create_qbr_metrics_tables(cursor, start_date='2025-07-01', end_date='2025-10-01', goals_start_date='2025-01-01'):
    ...
    execute_with_timing(cursor, """
        ...
        FROM users u
        JOIN tmp_apple_users au ON u.id = au.user_id
    ...
    execute_with_timing(cursor, f"""
        ...
        JOIN tmp_apple_users au ON ba.user_id = au.user_id
    ...
    execute_with_timing(cursor, """
        ...
        JOIN tmp_apple_users au ON fae.user_id = au.user_id
    ...
    execute_with_timing(cursor, f"""
        ...
        JOIN tmp_apple_users au ON qr.user_id = au.user_id
    ...
    execute_with_timing(cursor, f"""
        ...
        JOIN tmp_apple_users au ON au.user_id = qr.user_id
    ...
    execute_with_timing(cursor, f"""
        ...
        JOIN tmp_apple_users au ON au.user_id = mc.user_id
    ...
    execute_with_timing(cursor, """
        ...
        JOIN tmp_apple_users au ON au.user_id = mcg.user_id
    ...
    execute_with_timing(cursor, """
        ...
        SELECT 
            ...
            COUNT(DISTINCT glp1.user_id) as glp1_users_total,
            'GLP1 Users' as user_segment
            
        FROM tmp_apple_users au
        INNER JOIN tmp_apple_glp1_users glp1 ON au.user_id = glp1.user_id  -- Only GLP1 users
        LEFT JOIN tmp_baseline_weight bw ON au.user_id = bw.user_id
        LEFT JOIN tmp_latest_weight lw ON au.user_id = lw.user_id
        LEFT JOIN tmp_baseline_bmi bb ON au.user_id = bb.user_id
        LEFT JOIN tmp_latest_bmi lb ON au.user_id = lb.user_id
...
def create_source_table_indexes(cursor):
    ...
    indexes_to_create = [
        ("body_weight_values_cleaned", "user_id"),
        ("body_weight_values_cleaned", "effective_date"),
        ("bmi_values_cleaned", "user_id"),
        ("bmi_values_cleaned", "effective_date"),
        ("a1c_values", "user_id"),
...
def main(partner='Apple', analysis_start_date='2025-01-01', analysis_end_date='2025-10-01', goals_start_date='2025-01-01'):
    ...
    try:
        ...
        create_apple_users_table(cursor, partner, analysis_end_date)
        ...
        # Updated cleanup to include new detailed tables
        cleanup_start = time.time()
        cleanup_tables = [
            'tmp_apple_users', 'tmp_baseline_weight', 'tmp_latest_weight',
            'tmp_baseline_bmi', 'tmp_latest_bmi', 'tmp_baseline_a1c', 
            'tmp_latest_a1c', 'tmp_apple_glp1_users',
            # QBR metrics tables
            ...
            'tmp_a1c_analysis', 'tmp_module_completion', 'tmp_health_outcomes', 'tmp_weight_medians',  # Added tmp_weight_medians
        ]
...
if __name__ == "__main__":
    ...
    # main(partner='Apple', analysis_start_date='2025-07-01', analysis_end_date='2025-09-30', goals_start_date='2025-01-01')
    # main(partner='Walmart', analysis_start_date='2025-01-01', analysis_end_date='2025-12-31', goals_start_date='2024-01-01')
    main()  # Uses defaults: Apple, 2025-07-01 to 2025-09-30, goals from 2025-01-01